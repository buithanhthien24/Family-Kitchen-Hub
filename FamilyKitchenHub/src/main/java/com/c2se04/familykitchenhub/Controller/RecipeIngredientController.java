...
public class RecipeIngredientController {
    ...
    public ResponseEntity<RecipeIngredientDTO> addIngredient(
        ...
        RecipeIngredient created = recipeIngredientService.addIngredient(recipeId, ingredient);
    ...
    public ResponseEntity<RecipeIngredientDTO> updateIngredient(
            ...
            @RequestBody RecipeIngredient ingredient) {
        RecipeIngredient updated = recipeIngredientService.updateIngredient(ingredientId, ingredient);
        RecipeIngredientDTO dto = new RecipeIngredientDTO(
                updated.getId(),
